            ...
            >
              ...
              {operation.operationType === OperationType.TRANSFER_OUT && (
                <>
                  ...
                  <button aria-label={`Сохранить перевод ${operation.details.recipient} ${convertNumberToWordsRu(operation.details.amount / 100)}`} className={styles.toActions} onClick={() => handleSaveOperation(operation)}>
              ...
              {operation.operationType === OperationType.PAYMENT && (
                <>
                  ...
                  <button aria-label="Кнопка быстрого сохранения операции" className={styles.toActions}
